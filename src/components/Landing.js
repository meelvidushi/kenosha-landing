...
function Landing() {
  return (
    <section className="bg-white pt-16 pb-16 dark:bg-gray-900">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          ...
          <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
            AI solutions for the <span className="bg-gradient-to-r from-blue-500 to-teal-400 bg-clip-text text-transparent">Clinical Research</span> industry
          </h1>              <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Kenosha AI is an enterprise-grade GPT-class artificial intelligence (AI) platform built for the clinical research industry. </p>
