...
function InformationLong() {
  ...
  <section class="bg-slate-100 dark:bg-gray-900">
    ...
    <div class="p-16 mx-auto max-w-screen-xl text-center sm:py-16 lg:px-6">
      <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">The most trusted medical RFP platform</h2>
      <p class="text-gray-500 sm:text-xl dark:text-gray-400">Here are a few reasons why you should choose Kenosha AI</p>
      <div class="mt-8 lg:mt-12 space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <p class="mb-4 text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">24/7 Customer Service</h3>
              <p class="mb-4 text-gray-500 dark:text-gray-400">Tempus iaculis urna id volutpat lacus laoreet. Eget lorem dolor sed viverra ipsum. A lacus vestibulum sed arcu non odio.</p>
          ...
          <div>
              ...
              <p class="mb-4 text-gray-500 dark:text-gray-400">Eget lorem dolor sed viverra ipsum. A lacus vestibulum sed arcu non odio. Ac ut consequat semper viverra nam libero justo.</p>
