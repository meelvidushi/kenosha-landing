  ...
  return (
    <div className='p-16 pb-0 pt-0'> 
      <div className="gap-8 items-center mx-auto max-w-screen-xl xl:gap-16 md:flex md:justify-between md:items-center sm:py-16 lg:px-6">
        ...
        <img className="w-full md:w-1/ hidden dark:block" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/cta/cta-dashboard-mockup-dark.svg" alt="Dashboard dark mode" />
        ...
        <div className="md:w-1/2">
          ...
          <div className="text-left">
            <a href="https://kenosha.ai/" style={{ backgroundColor: '#171c84' }} className="inline-flex items-center text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:focus:ring-primary-900">
              Get started
